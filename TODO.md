...
- [ ] Реализовать систему меню согласно analyze-prj.md
  ...
  - [ ] Этап 2: Обработка кнопок и роутинг
  - [ ] Этап 3: Интеграция с командой /start
  - [ ] Этап 4: Реализация управления меню
  - [ ] Этап 5: Интеграция в плагины

## Выполненные задачи (2025-09-27)

### Создана базовая структура системы меню:
- [x] **Файл menu_system.py**: создан базовый файл с компонентами системы меню
- [x] **MenuEntry**: реализован класс для хранения информации о пунктах меню
- [x] **Глобальные структуры**: добавлены MENU_REGISTRY и MENU_CACHE
- [x] **Функция register_menu()**: для регистрации пунктов меню
- [x] **Функция build_menu()**: для построения кнопок на основе реестра
- [x] **Вспомогательные функции**: invalidate_menu, dispatch_command, send_main_menu
- [x] **Инициализация роутера**: функция init_menu_system для обработки callback-кнопок
